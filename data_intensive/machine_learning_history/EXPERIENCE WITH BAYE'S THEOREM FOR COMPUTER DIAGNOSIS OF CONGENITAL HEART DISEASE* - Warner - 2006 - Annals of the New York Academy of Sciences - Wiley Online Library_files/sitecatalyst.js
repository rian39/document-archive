...
s.wolprop1=s.prop1;
s.wolprop2=s.prop2;
	if(document.location.hash.indexOf("cochrane=summary")>=0){
		s.prop1='ABSTRACT';
		s.prop2='READCUBE COCHRANE SUMMARY PDF';
		s.events='event17';
	}
	else if(document.location.hash.indexOf("cochrane=standard")>=0){
		s.prop1='FULLTEXT';
		s.prop2='READCUBE COCHRANE STANDARD FULLTEXT PDF';
		s.events='event64';
	}
	else if(document.location.hash.indexOf("cochrane=full")>=0){
		s.prop1='FULLTEXT';
		s.prop2='READCUBE COCHRANE FULL FULLTEXT PDF';
		s.events='event64';
	}
	else{
		s.prop1='FULLTEXT';
